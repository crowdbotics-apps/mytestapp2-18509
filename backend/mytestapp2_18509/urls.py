"""mytestapp2_18509 URL Configuration
...
admin.site.site_header = "MytestApp2"
admin.site.site_title = "MytestApp2 Admin Portal"
admin.site.index_title = "MytestApp2 Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="MytestApp2 API",
        default_version="v1",
        description="API documentation for MytestApp2 App",
    ),
    public=True,
